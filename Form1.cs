...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
            ...
            //======================================================
        {
            ...
            //pstrSQL = "Select * into SealTestDB2a.dbo.tblReportGenImage from SealTestDB2.dbo.tblReportGenImage ";
            //modMain.gDB.ExecuteCommand(pstrSQL, "SealTestDB2a");
            ...
            while (pDR.Read())
            {
                pstrINSERT = "INSERT INTO tblReportGenImage (fldTestProjectID, fldTestMOID, fldTestRptID, fldImageID, fldImageFile, fldImageNameTag, " +
                                                             "fldImageCaption, fldImage, fldSelected)";
